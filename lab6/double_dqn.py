...
def main():
    ...
    parser.add_argument('--logdir', default='log/ddqn_'+ TIMESTAMP)
    # train
    ...
    parser.add_argument('--capacity', default=10000, type=int) #20000
    parser.add_argument('--batch_size', default=128, type=int) #128
    parser.add_argument('--lr', default=.0005, type=float)
    parser.add_argument('--eps_decay', default=.995, type=float)
    parser.add_argument('--eps_min', default=.01, type=float) #.005
